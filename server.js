...
// ★ 운세 패턴 확장 — 띠당 21 → 30개 (총 12×30 = 360개). 띠별 특성 살려 추가.
//   분포 추가: 대길+1 / 중길+2 / 소길+3 / 평+2 / 주의+1 (= 띠당 +9개).
(function appendExtraFortunes() {
  const extra = {
    '쥐': [
      {g:'대길',t:'예리한 직감이 오늘만큼은 절대 빗나가지 않아요. 평소 미뤄둔 결정을 오늘 내리면 후회 없을 거예요.'},
      {g:'중길',t:'주변에서 들려오는 작은 정보 하나가 오늘 의외의 가치를 만들어요. 귀를 활짝 열어두세요.'},
      {g:'중길',t:'꼼꼼한 점검 한 번이 큰 사고를 막는 하루. 중요한 일일수록 한번 더 확인하세요.'},
      {g:'소길',t:'친한 사람과의 짧은 대화에서 좋은 아이디어를 얻을 수 있는 날이에요.'},
      {g:'소길',t:'계산이 빠른 머리가 오늘 작지만 알찬 이득을 가져와요. 숫자에 집중해 보세요.'},
      {g:'소길',t:'메모해 둔 작은 일들이 오늘 차근차근 정리되는 시원한 하루예요.'},
      {g:'평',t:'큰 변화 없는 잔잔한 하루. 페이스 흐트러지지 않게 자기 리듬 유지하세요.'},
      {g:'평',t:'눈에 띄는 일은 없어도 작은 만족이 이어지는 평온한 날이에요.'},
      {g:'주의',t:'머릿속만 빨리 돌리고 행동은 늦어질 수 있어요. 한 가지라도 매듭을 짓고 가세요.'},
    ],
    '소': [
      {g:'대길',t:'꾸준함이 마침내 결실을 맺는 황금 같은 날이에요. 오늘 받는 보상은 그동안의 노력 덕분이에요.'},
      {g:'중길',t:'서두르지 않아도 자연스럽게 일이 풀리는 흐름. 차분히 가던 길 그대로 가세요.'},
      {g:'중길',t:'믿음직한 모습이 주변에 깊은 인상을 남기는 하루예요.'},
      {g:'소길',t:'어제 마무리한 일이 오늘 좋은 평가로 돌아와요. 노력은 헛되지 않아요.'},
      {g:'소길',t:'한결같은 마음이 오늘 누군가에게 큰 힘이 돼요. 곁에 있어주는 것만으로도 충분해요.'},
      {g:'소길',t:'몸은 피곤해도 마음은 든든한 하루. 작은 성취감이 차곡차곡 쌓여요.'},
      {g:'평',t:'평소처럼 묵묵히 보내는 하루지만 그 안정감이 곧 큰 자산이에요.'},
      {g:'평',t:'큰 욕심 없이 보내는 따뜻한 하루. 가족과의 대화가 마음을 편안하게 해줘요.'},
      {g:'주의',t:'고집이 자칫 변화를 막을 수 있어요. 새로운 의견에 한 번쯤 귀 기울여 보세요.'},
    ],
    '호랑이': [
      {g:'대길',t:'카리스마가 폭발하는 날! 회의나 모임에서 자연스럽게 중심에 서게 되고 좋은 결과가 따라와요.'},
      {g:'중길',t:'결단력 있는 한마디가 오늘 분위기를 단번에 바꿔놓아요. 망설이지 말고 의견을 내세요.'},
      {g:'중길',t:'오랜만에 만난 사람과의 시간이 마음을 든든하게 채워주는 하루예요.'},
      {g:'소길',t:'활동량을 늘릴수록 운이 따라오는 날. 가만히 있지 말고 움직여 보세요.'},
      {g:'소길',t:'용기 있는 한 걸음이 의외로 큰 변화를 가져올 수 있어요.'},
      {g:'소길',t:'체력적으로 부담은 있어도 정신적으로 만족스러운 하루가 될 거예요.'},
      {g:'평',t:'큰 도전 없는 평탄한 하루. 잠시 숨 고르며 다음 라운드 준비하세요.'},
      {g:'평',t:'지나치게 앞서나가지 않아도 충분히 좋은 날이에요. 자기 페이스 지키세요.'},
      {g:'주의',t:'욱하는 한마디가 오랜 관계를 흔들 수 있어요. 화는 30초만 참아도 큰 도움이 돼요.'},
    ],
    '토끼': [
      {g:'대길',t:'주변 사람들의 따뜻한 응원이 큰 힘이 되는 날! 부드러운 매력이 오늘 가장 빛나요.'},
      {g:'중길',t:'오랜 인연에게서 반가운 소식이 도착할 수 있어요. 연락 한 통이 위로가 돼요.'},
      {g:'중길',t:'섬세한 배려가 누군가의 하루를 환하게 만드는 하루예요.'},
      {g:'소길',t:'편안한 분위기 속에서 좋은 대화가 자연스럽게 이어지는 날이에요.'},
      {g:'소길',t:'취미 활동이나 좋아하는 일에 시간을 쓰면 마음이 가벼워져요.'},
      {g:'소길',t:'소소한 선물이나 친절을 받게 되는 따뜻한 하루가 될 거예요.'},
      {g:'평',t:'잔잔한 일상이 오늘은 가장 큰 행복이에요. 평범함을 즐기세요.'},
      {g:'평',t:'특별한 사건은 없지만 마음만큼은 평화로운 하루가 흘러가요.'},
      {g:'주의',t:'거절을 못 해서 무리한 부탁을 받을 수 있어요. 안 되는 건 정중히 안 된다고 말하세요.'},
    ],
    '용': [
      {g:'대길',t:'하늘이 크게 열리는 날! 평소 상상만 하던 일이 오늘 현실로 다가올 수 있어요.'},
      {g:'중길',t:'큰 그림을 그려두면 오늘 그 첫 걸음이 자연스럽게 떨어져요. 비전을 떠올려 보세요.'},
      {g:'중길',t:'도전하는 자세가 오늘 주변 사람들에게도 좋은 자극이 돼요.'},
      {g:'소길',t:'평소보다 한 단계 높은 시도가 작은 성취로 이어지는 날이에요.'},
      {g:'소길',t:'에너지가 넘쳐서 여러 일을 동시에 해내는 효율적인 하루예요.'},
      {g:'소길',t:'꿈꾸던 일에 작은 진전이 보이는 의미 있는 하루가 될 거예요.'},
      {g:'평',t:'폭발적이지 않아도 꾸준히 흐르는 안정된 하루예요.'},
      {g:'평',t:'큰 일은 없지만 작은 보람이 곳곳에 숨어있는 하루가 될 거예요.'},
      {g:'주의',t:'큰 욕심이 작은 실수를 부를 수 있어요. 한 번에 다 가지려 말고 단계별로 가세요.'},
    ],
    '뱀': [
      {g:'대길',t:'오랫동안 풀리지 않던 문제가 오늘 명쾌하게 해답을 보여주는 특별한 날이에요.'},
      {g:'중길',t:'직감을 믿고 행동하면 후회 없는 결과가 따라와요. 첫 느낌이 정답일 때가 많아요.'},
      {g:'중길',t:'깊이 있는 대화가 오늘 좋은 인연을 만들어줄 거예요.'},
      {g:'소길',t:'책 한 권, 영상 하나에서 인생을 바꿀 만한 통찰을 얻을 수 있어요.'},
      {g:'소길',t:'조용한 시간이 오히려 가장 생산적인 하루가 돼요.'},
      {g:'소길',t:'꼼꼼한 분석이 오늘 좋은 판단으로 이어지는 알찬 날이에요.'},
      {g:'평',t:'눈에 띄지 않아도 내실 있는 하루를 보내는 차분한 날이에요.'},
      {g:'평',t:'겉보다 속이 풍요로워지는 하루. 자기 성찰의 시간 가져보세요.'},
      {g:'주의',t:'의심이 너무 깊으면 좋은 기회도 놓칠 수 있어요. 가끔은 사람을 믿어보세요.'},
    ],
    '말': [
      {g:'대길',t:'에너지가 분출하듯 솟구치는 날! 오늘 시작하는 일은 무엇이든 좋은 추진력을 받아요.'},
      {g:'중길',t:'여행이나 외출에서 좋은 인연을 만나거나 신선한 자극을 받게 돼요.'},
      {g:'중길',t:'체력이 받쳐주는 만큼 일이 술술 풀리는 활기찬 하루예요.'},
      {g:'소길',t:'운동이나 산책으로 몸을 움직이면 머리도 같이 맑아지는 날이에요.'},
      {g:'소길',t:'오늘 새로 시작한 작은 습관이 미래의 큰 변화로 이어질 수 있어요.'},
      {g:'소길',t:'주변과 함께하는 활동이 즐거움과 성과를 동시에 가져와요.'},
      {g:'평',t:'바쁘지도 한가하지도 않은 적당한 하루가 흐르는 날이에요.'},
      {g:'평',t:'오늘만큼은 잠시 속도 줄이고 풍경을 즐겨보세요.'},
      {g:'주의',t:'너무 빨리 달리다 작은 디테일을 놓칠 수 있어요. 가끔 멈춰서 점검하세요.'},
    ],
    '양': [
      {g:'대길',t:'베푼 만큼 정확히 두 배로 돌아오는 신기한 하루! 작은 친절이 큰 복으로 보답돼요.'},
      {g:'중길',t:'주변에 도움을 주거나 조언을 건네는 일이 오늘 자기 자신에게도 큰 의미로 남아요.'},
      {g:'중길',t:'마음이 따뜻해지는 만남이나 메시지가 도착할 가능성이 높아요.'},
      {g:'소길',t:'평소 신경 쓰던 일에서 작은 진전을 느끼는 만족스러운 하루예요.'},
      {g:'소길',t:'음악이나 예술 작품에서 깊은 위로를 얻는 감성적인 날이에요.'},
      {g:'소길',t:'소박한 식사가 그 어떤 진수성찬보다 행복하게 느껴지는 하루예요.'},
      {g:'평',t:'큰 일 없는 잔잔한 하루지만 그 평화로움이 가장 큰 선물이에요.'},
      {g:'평',t:'오늘은 자신을 돌보는 시간을 충분히 가져보세요.'},
      {g:'주의',t:'거절 못해 마음만 무거워질 수 있어요. 자신의 에너지부터 챙기세요.'},
    ],
    '원숭이': [
      {g:'대길',t:'번뜩이는 아이디어가 오늘 큰 가치를 만들어내는 날! 떠오르는 생각을 즉시 메모하세요.'},
      {g:'중길',t:'유머와 재치 있는 대화가 분위기를 한층 밝게 만들어요. 분위기 메이커가 되는 하루.'},
      {g:'중길',t:'여러 일을 동시에 처리하는 능력이 오늘 빛을 발하는 하루예요.'},
      {g:'소길',t:'새로운 것을 배우면 평소보다 훨씬 빨리 익히는 학습 효율이 높은 날이에요.'},
      {g:'소길',t:'낯선 사람과의 짧은 만남에서 의외의 인사이트를 얻을 수 있어요.'},
      {g:'소길',t:'게임이나 퀴즈처럼 머리 쓰는 활동이 즐거움과 보람을 동시에 줘요.'},
      {g:'평',t:'크게 자극적이지 않아도 일상의 재미가 곳곳에 있는 하루예요.'},
      {g:'평',t:'오늘은 호기심 가는 일에 자유롭게 시간을 써도 좋아요.'},
      {g:'주의',t:'잔꾀가 큰 손실로 이어질 수 있어요. 정직함이 오늘 가장 빛나는 무기예요.'},
    ],
    '닭': [
      {g:'대길',t:'아침부터 모든 일이 척척 맞아 들어가는 환상의 하루! 오늘 한 작업은 평소 두 배 효율이에요.'},
      {g:'중길',t:'꼼꼼한 정리정돈이 마음의 평화를 가져와요. 책상이나 집을 한 번 정리해 보세요.'},
      {g:'중길',t:'시간을 잘 활용하는 능력이 오늘 큰 차이를 만드는 하루예요.'},
      {g:'소길',t:'하루 일과를 미리 계획하면 평소보다 두 배는 효율적이에요.'},
      {g:'소길',t:'작은 약속도 정확히 지키는 모습이 신뢰를 쌓는 좋은 날이에요.'},
      {g:'소길',t:'꾸준히 해온 일에서 작은 성과가 가시화되는 보람찬 하루예요.'},
      {g:'평',t:'특별한 일은 없어도 차곡차곡 진전이 보이는 알찬 하루가 흘러가요.'},
      {g:'평',t:'평소 루틴을 지키는 것이 오늘은 최고의 선택이에요.'},
      {g:'주의',t:'너무 완벽하려다 시작조차 못 할 수 있어요. 80% 정도로 일단 시작하세요.'},
    ],
    '개': [
      {g:'대길',t:'오랜 친구나 가족에게서 큰 힘과 위로를 받는 따뜻한 하루! 인복이 폭발하는 날이에요.'},
      {g:'중길',t:'신뢰받는 모습이 오늘 좋은 기회로 이어지는 의미 있는 하루예요.'},
      {g:'중길',t:'믿음직한 한 사람의 한마디가 큰 결정에 도움이 될 거예요.'},
      {g:'소길',t:'평소 잘 챙겨온 사람에게서 따뜻한 보답을 받게 되는 흐뭇한 하루.'},
      {g:'소길',t:'작은 약속을 지키는 모습이 오늘 누군가에게 깊은 감동을 줘요.'},
      {g:'소길',t:'함께하는 사람들과의 시간이 가장 큰 행복인 하루예요.'},
      {g:'평',t:'눈에 띄는 일은 없어도 곁의 사람들이 든든하게 느껴지는 하루.'},
      {g:'평',t:'평범한 일상 속 작은 행복이 오늘만큼은 더 크게 다가와요.'},
      {g:'주의',t:'너무 곁에 매여 자신을 잃을 수 있어요. 자기만의 시간도 챙기세요.'},
    ],
    '돼지': [
      {g:'대길',t:'풍요로운 기운이 사방에서 들어오는 황금의 하루! 음식·돈·인연 모두에서 좋은 일이 생겨요.'},
      {g:'중길',t:'맛있는 음식 한 끼가 마음의 영양까지 채워주는 행복한 하루예요.'},
      {g:'중길',t:'낙천적인 자세가 주변에 좋은 기운을 퍼뜨리는 분위기 메이커가 돼요.'},
      {g:'소길',t:'소소한 즐거움이 곳곳에 숨어있는 발견의 기쁨이 있는 하루예요.'},
      {g:'소길',t:'나눔과 베풂이 자연스럽게 이어지는 마음 따뜻한 날이에요.'},
      {g:'소길',t:'평소 좋아하던 활동에 시간을 쓰면 가장 행복한 하루가 돼요.'},
      {g:'평',t:'특별한 일은 없어도 일상이 풍요롭게 느껴지는 안정된 날.'},
      {g:'평',t:'오늘은 욕심 없이 있는 그대로의 시간을 즐겨보세요.'},
      {g:'주의',t:'과식이나 과음이 다음날 부담으로 돌아올 수 있어요. 적당히가 최고예요.'},
    ],
  };
  Object.keys(extra).forEach(function (z) {
    if (FORTUNE[z]) FORTUNE[z] = FORTUNE[z].concat(extra[z]);
  });
})();

// ★ FORTUNE 배열 grade 인터리브 — 각 띠 30개 운세에서 대길/중길/소길/평/주의 가
//   골고루 분산되도록 재정렬. 이전 21개 시점엔 대길 2개가 인덱스 0,1 에만 있어
//   가족 멤버 id 패턴에 따라 가족 누구도 며칠간 대길 못 보던 버그가 있었음.
//   인터리브 + 30개 확장 후 대길은 0/5/10 인덱스 — 매일 가족 1명 이상 대길 가능.
