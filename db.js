...
async function ensureSchema() {
  ...
  await ensureColumn('memos', 'recurring', 'VARCHAR(20) NULL');
  ...
  await p.query(`
    CREATE TABLE IF NOT EXISTS custom_questions (
      ...
      used_date DATE NULL,
      created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
      INDEX idx_family_pending (family_id, used_date, created_at)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  `);
  ...
  await p.query(`
    CREATE TABLE IF NOT EXISTS personal_diary (
      ...
      INDEX idx_user_time (user_id, entry_date)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  `);
  ...
  await p.query(`
    CREATE TABLE IF NOT EXISTS answer_comments (
      ...
      text VARCHAR(300) NOT NULL,
      created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
      INDEX idx_answer_time (answer_id, created_at)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  `);
  ...
  await p.query(`
    CREATE TABLE IF NOT EXISTS family_events (
      ...
      created_by INT NULL,
      created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
      INDEX idx_family_date (family_id, event_date)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
  `);
